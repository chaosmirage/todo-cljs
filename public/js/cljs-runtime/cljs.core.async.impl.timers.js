...
var i_27620 = (self__.level + (1));
while(true){
if((i_27620 <= (new_level + (1)))){
(update[i_27620] = self__.header);

var G__27624 = (i_27620 + (1));
i_27620 = G__27624;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_27626 = (update[i]).forward;
(x__$2.forward[i] = (links_27626[i]));
...
var i_27631 = (0);
while(true){
if((i_27631 <= self__.level)){
var links_27632 = (update[i_27631]).forward;
if((x__$1 === (((i_27631 < links_27632.length))?(links_27632[i_27631]):null))){
(links_27632[i_27631] = (x__$1.forward[i_27631]));

var G__27636 = (i_27631 + (1));
i_27631 = G__27636;
continue;
} else {
var G__27637 = (i_27631 + (1));
i_27631 = G__27637;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__27658 = nx;
var G__27659 = (level__$1 - (1));
x = G__27658;
level__$1 = G__27659;
continue;
} else {
var G__27660 = x;
var G__27661 = (level__$1 - (1));
x = G__27660;
level__$1 = G__27661;
continue;
}
