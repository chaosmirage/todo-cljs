...
if((i < len)){
var k = (ks[i]);
var G__35636 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35637 = (i + (1));
m = G__35636;
i = G__35637;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35526 = c;
var G__35526__$1 = (((G__35526 == null))?null:G__35526.prototype);
if((G__35526__$1 == null)){
return null;
} else {
return (G__35526__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35532 = c;
var G__35532__$1 = (((G__35532 == null))?null:G__35532.prototype);
if((G__35532__$1 == null)){
return null;
} else {
return (G__35532__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__35639__delegate = function (args){
var G__35539 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35539) : reagent.impl.component.as_element.call(null,G__35539));
};
...
while (G__35640__i < G__35640__a.length) {G__35640__a[G__35640__i] = arguments[G__35640__i + 0]; ++G__35640__i;}
  args = new cljs.core.IndexedSeq(G__35640__a,0,null);
} 
return G__35639__delegate.call(this,args);};
...
return G__35639__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__35543 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35544 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35544);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35543);
}});
...
var c = this;
var G__35548_35645 = (c["cljsRatom"]);
if((G__35548_35645 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35548_35645);
}
...
var renders_35646 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_35647 = cljs.core.first(cljs.core.vals(renders_35646));
if((cljs.core.count(renders_35646) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35646))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35647)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35647], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35573 = name;
switch (G__35573) {
case "":
...
var name = (function (){var G__35587 = fiber;
var G__35587__$1 = (((G__35587 == null))?null:(G__35587["type"]));
if((G__35587__$1 == null)){
return null;
} else {
return (G__35587__$1["displayName"]);
}
})();
var parent = (function (){var G__35588 = fiber;
if((G__35588 == null)){
return null;
} else {
return (G__35588["return"]);
}
})();
var path = (function (){var G__35589 = parent;
var G__35589__$1 = (((G__35589 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35589) : reagent.impl.component.fiber_component_path.call(null,G__35589)));
if((G__35589__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35589__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4126__auto__ = (function (){var G__35612 = c;
if((G__35612 == null)){
return null;
} else {
return (G__35612["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
return G__35613._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4126__auto__ = (function (){var G__35617 = c;
if((G__35617 == null)){
return null;
} else {
return (G__35617["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var or__4126__auto____$1 = (function (){var G__35619 = c;
if((G__35619 == null)){
return null;
} else {
return G__35619._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4126__auto__ = (function (){var G__35621 = instance;
if((G__35621 == null)){
return null;
} else {
return (G__35621["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var G__35622 = instance;
if((G__35622 == null)){
return null;
} else {
return G__35622._currentElement;
}
}
})();
var name = (function (){var G__35623 = elem;
var G__35623__$1 = (((G__35623 == null))?null:(G__35623["type"]));
if((G__35623__$1 == null)){
return null;
} else {
return (G__35623__$1["displayName"]);
}
})();
var owner = (function (){var or__4126__auto__ = (function (){var G__35625 = elem;
if((G__35625 == null)){
return null;
} else {
return (G__35625["_owner"]);
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
return G__35626._owner;
}
}
})();
var path = (function (){var G__35627 = owner;
var G__35627__$1 = (((G__35627 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35627) : reagent.impl.component.component_path.call(null,G__35627)));
if((G__35627__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35627__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35632 = c;
var G__35632__$1 = (((G__35632 == null))?null:G__35632.constructor);
if((G__35632__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35632__$1);
}
}
})();
