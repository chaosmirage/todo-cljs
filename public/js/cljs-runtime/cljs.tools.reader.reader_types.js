...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26691 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26691(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26692 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26692(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26693 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26693(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26697 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26697(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26700 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26700(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26706 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26706(reader);
}
});
...
var G__26832 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26833 = s.append(c);
c = G__26832;
s = G__26833;
continue;
}
